...
$data=mysqli_fetch_array(mysqli_query("select nama_lengkap from admin where id_admin='$parameter'"));
return $data[0];
}
function random(){
echo rand(0,999);
...
function selisihwaktu($waktupembuatan){$waktusekarang=date("Y-m-d h:i:s");
